...
#include <vector>
#include <queue>
#include "Player4592088745920887.h"
...
// Constructor
Player45920887::Player45920887(int jug){
    jugador_=jug;
}

// Actualiza el estado del juego para el jugador
void Player45920887::Perceive(const Environment & env){
    actual_=env;
}
...
Environment::ActionType Player45920887::Think(){
